...
\begin{document}
	...
	DRL has been widely applied such as for visual and off-road navigation, quad-rotor flight control, and learning the motion of marine robots. A representative example is the Deep Deterministic Policy Gradient (DDPG) framework employing an actor–critic architecture to process sensory inputs and generate linear and angular velocity commands (see Fig.~\ref{fig:fig4}).
